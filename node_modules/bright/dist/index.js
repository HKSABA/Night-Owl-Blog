...
__export(src_exports, {
  Code: () => Code,
  linesToContent: () => linesToContent,
  tokensToContent: () => tokensToContent,
  tokensToTokenList: () => tokensToTokenList
});
module.exports = __toCommonJS(src_exports);
var import_lighter2 = require("@code-hike/lighter");
...
function TitleBar(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ...elementProps, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TitleBarContent2, { ...props }),
...
function TitleBarContent(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tab, { ...props });
}
function Tab(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabContent2, { ...props }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "div",
          {
            style: {
...
function TabContent(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: props.title });
}
...
function TokensRenderer({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: tokens.map(
    (token, i) => "content" in token ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TokenRenderer, { token, brightProps }, i) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      TokenGroupRenderer,
      {
        tokens: token,
        brightProps
...
function TokenGroupRenderer({
  ...
  if (!Wrapper) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TokensRenderer, { tokens: tokens.tokens, brightProps });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    Wrapper,
    {
      ...
      brightProps,
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TokensRenderer, { tokens: tokens.tokens, brightProps })
    }
  );
}
function TokenRenderer({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: token.style, children: token.content });
}
...
function LinesComponent({
  ...
  const { extensions } = brightProps;
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: lines.map((line, i) => {
    if ("lineNumber" in line) {
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LineComponent, { line, brightProps }, i);
    }
    ...
    if (extension == null ? void 0 : extension.MultilineAnnotation) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        Wrapper,
        {
          ...
          lines: line.lines,
          brightProps,
          children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LinesComponent, { lines: line.lines, brightProps })
        },
        i
      );
    } else {
...
function LineComponent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { padding: "0 1em" }, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
    digits > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      "span",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TokensRenderer, { tokens: line.tokens, brightProps }),
...
async function BrightCode(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Root2, { ...brightProps });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Pre2, { ...props })
      ]
    }
  );
}
    ...
    "pre",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "code",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(LinesComponent, { lines, brightProps })
        }
      )
    }
  );
...
function Style({
  ...
  `;
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("style", { dangerouslySetInnerHTML: { __html: css } });
}
...
var Code = async (componentProps) => {
  ...
  if (!isDouble) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(AnnotatedCode, { ...props, theme });
  }
...
async function AnnotatedCode(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BrightCode, { ...newProps });
}
...
async function extractAnnotationsFromCode(props) {
  ...
  const { code: newCode, annotations } = await (0, import_lighter2.extractAnnotations)(
    code,
    lang,
    extensionNames
  );
...
function parseChildren(children, lang, code) {
  ...
  if (typeof children === "string" || code) {
    ...
    if (!import_lighter2.LANG_NAMES.includes(newLang2)) {
